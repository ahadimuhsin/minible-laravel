...
<div class="col-md-8 col-lg-6 col-xl-5">
    <div class="card">
        ...
        <div class="card-body p-4"> 
            ...
            <div class="p-2 mt-4">
                <form action="https://themesbrand.com/minible/layouts/index.html" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control  @error('password') is-invalid @enderror" required name="password" id="password" placeholder="Password">
